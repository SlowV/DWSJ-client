...
public class Xmlcomment  implements java.io.Serializable {
    ...
    private com.quanganh9x.springwsclient.endpoint.rating.Xmluser user;
    ...
    public Xmlcomment(
           ...
           com.quanganh9x.springwsclient.endpoint.rating.Xmluser user,
     ...
     * @return user
     */
    public com.quanganh9x.springwsclient.endpoint.rating.Xmluser getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(com.quanganh9x.springwsclient.endpoint.rating.Xmluser user) {
        this.user = user;
    }
