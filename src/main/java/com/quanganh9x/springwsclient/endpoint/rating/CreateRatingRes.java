...
public class CreateRatingRes  implements java.io.Serializable {
    private com.quanganh9x.springwsclient.endpoint.rating.Xmlrating rating;

    public CreateRatingRes() {
    }
    ...
    /**
     * Gets the rating value for this CreateRatingRes.
     * 
     * @return rating
     */
    ...
    /**
     * Sets the rating value for this CreateRatingRes.
     * 
     * @param rating
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateRatingRes)) return false;
        CreateRatingRes other = (CreateRatingRes) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateRatingRes.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://quanganh9x.com/soap", ">createRatingRes"));
