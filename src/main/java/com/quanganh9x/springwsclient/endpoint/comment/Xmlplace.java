...
public class Xmlplace  implements java.io.Serializable {
    ...
    private com.quanganh9x.springwsclient.endpoint.comment.Xmlplace[] places;

    private com.quanganh9x.springwsclient.endpoint.comment.Xmlimage[] images;
    ...
    public Xmlplace(
           ...
           com.quanganh9x.springwsclient.endpoint.comment.Xmlplace[] places,
           com.quanganh9x.springwsclient.endpoint.comment.Xmlimage[] images,
     ...
     * @return places
     */
    public com.quanganh9x.springwsclient.endpoint.comment.Xmlplace[] getPlaces() {
        return places;
    }
     ...
     * @param places
     */
    public void setPlaces(com.quanganh9x.springwsclient.endpoint.comment.Xmlplace[] places) {
        this.places = places;
    }

    public com.quanganh9x.springwsclient.endpoint.comment.Xmlplace getPlaces(int i) {
        return this.places[i];
    }

    public void setPlaces(int i, com.quanganh9x.springwsclient.endpoint.comment.Xmlplace _value) {
     ...
     * @return images
     */
    public com.quanganh9x.springwsclient.endpoint.comment.Xmlimage[] getImages() {
        return images;
    }
     ...
     * @param images
     */
    public void setImages(com.quanganh9x.springwsclient.endpoint.comment.Xmlimage[] images) {
        this.images = images;
    }

    public com.quanganh9x.springwsclient.endpoint.comment.Xmlimage getImages(int i) {
        return this.images[i];
    }

    public void setImages(int i, com.quanganh9x.springwsclient.endpoint.comment.Xmlimage _value) {
