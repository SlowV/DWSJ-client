...
public class Xmlrating  implements java.io.Serializable {
    ...
    private com.quanganh9x.springwsclient.endpoint.comment.Xmluser user;

    private com.quanganh9x.springwsclient.endpoint.comment.Xmlplace place;
    ...
    public Xmlrating(
           int id,
           int point,
           com.quanganh9x.springwsclient.endpoint.comment.Xmluser user,
           com.quanganh9x.springwsclient.endpoint.comment.Xmlplace place,
     ...
     * @return user
     */
    public com.quanganh9x.springwsclient.endpoint.comment.Xmluser getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(com.quanganh9x.springwsclient.endpoint.comment.Xmluser user) {
        this.user = user;
    }
     ...
     * @return place
     */
    public com.quanganh9x.springwsclient.endpoint.comment.Xmlplace getPlace() {
        return place;
    }
     ...
     * @param place
     */
    public void setPlace(com.quanganh9x.springwsclient.endpoint.comment.Xmlplace place) {
        this.place = place;
    }
