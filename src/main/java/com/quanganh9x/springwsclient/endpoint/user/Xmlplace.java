...
public class Xmlplace  implements java.io.Serializable {
    ...
    private com.quanganh9x.springwsclient.endpoint.user.Xmlplace[] places;

    private com.quanganh9x.springwsclient.endpoint.user.Xmlimage[] images;
    ...
    public Xmlplace(
           ...
           com.quanganh9x.springwsclient.endpoint.user.Xmlplace[] places,
           com.quanganh9x.springwsclient.endpoint.user.Xmlimage[] images,
     ...
     * @return places
     */
    public com.quanganh9x.springwsclient.endpoint.user.Xmlplace[] getPlaces() {
        return places;
    }
     ...
     * @param places
     */
    public void setPlaces(com.quanganh9x.springwsclient.endpoint.user.Xmlplace[] places) {
        this.places = places;
    }

    public com.quanganh9x.springwsclient.endpoint.user.Xmlplace getPlaces(int i) {
        return this.places[i];
    }

    public void setPlaces(int i, com.quanganh9x.springwsclient.endpoint.user.Xmlplace _value) {
     ...
     * @return images
     */
    public com.quanganh9x.springwsclient.endpoint.user.Xmlimage[] getImages() {
        return images;
    }
     ...
     * @param images
     */
    public void setImages(com.quanganh9x.springwsclient.endpoint.user.Xmlimage[] images) {
        this.images = images;
    }

    public com.quanganh9x.springwsclient.endpoint.user.Xmlimage getImages(int i) {
        return this.images[i];
    }

    public void setImages(int i, com.quanganh9x.springwsclient.endpoint.user.Xmlimage _value) {
