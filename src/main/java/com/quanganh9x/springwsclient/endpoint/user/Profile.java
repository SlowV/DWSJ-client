...
public class Profile  implements java.io.Serializable {
    ...
    /**
     * Gets the id value for this Profile.
     * 
     * @return id
     */
    public int getId() {
    ...
    /**
     * Sets the id value for this Profile.
     * 
     * @param id
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://quanganh9x.com/soap", ">profile"));
