...
public class LoginRes  implements java.io.Serializable {
    ...
    /**
     * Gets the user value for this LoginRes.
     * 
     * @return user
     */
    ...
    /**
     * Sets the user value for this LoginRes.
     * 
     * @param user
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LoginRes)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LoginRes.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://quanganh9x.com/soap", ">loginRes"));
