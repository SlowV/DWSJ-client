...
public class GetImageRes  implements java.io.Serializable {
    ...
    /**
     * Gets the image value for this GetImageRes.
     * 
     * @return image
     */
    ...
    /**
     * Sets the image value for this GetImageRes.
     * 
     * @param image
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetImageRes)) return false;
        GetImageRes other = (GetImageRes) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetImageRes.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://quanganh9x.com/soap", ">getImageRes"));
