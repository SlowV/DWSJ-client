...
public class Xmluser  implements java.io.Serializable {
    ...
    private com.quanganh9x.springwsclient.endpoint.image.Xmlcomment[] comments;
    ...
    public Xmluser(
           ...
           com.quanganh9x.springwsclient.endpoint.image.Xmlcomment[] comments,
     ...
     * @return comments
     */
    public com.quanganh9x.springwsclient.endpoint.image.Xmlcomment[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(com.quanganh9x.springwsclient.endpoint.image.Xmlcomment[] comments) {
        this.comments = comments;
    }

    public com.quanganh9x.springwsclient.endpoint.image.Xmlcomment getComments(int i) {
        return this.comments[i];
    }

    public void setComments(int i, com.quanganh9x.springwsclient.endpoint.image.Xmlcomment _value) {
