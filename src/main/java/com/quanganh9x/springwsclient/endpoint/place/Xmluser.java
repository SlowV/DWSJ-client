...
public class Xmluser  implements java.io.Serializable {
    ...
    private com.quanganh9x.springwsclient.endpoint.place.Xmlcomment[] comments;

    private com.quanganh9x.springwsclient.endpoint.place.Xmlrating[] ratings;
    ...
    public Xmluser(
           ...
           com.quanganh9x.springwsclient.endpoint.place.Xmlcomment[] comments,
           com.quanganh9x.springwsclient.endpoint.place.Xmlrating[] ratings,
     ...
     * @return comments
     */
    public com.quanganh9x.springwsclient.endpoint.place.Xmlcomment[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(com.quanganh9x.springwsclient.endpoint.place.Xmlcomment[] comments) {
        this.comments = comments;
    }

    public com.quanganh9x.springwsclient.endpoint.place.Xmlcomment getComments(int i) {
        return this.comments[i];
    }

    public void setComments(int i, com.quanganh9x.springwsclient.endpoint.place.Xmlcomment _value) {
     ...
     * @return ratings
     */
    public com.quanganh9x.springwsclient.endpoint.place.Xmlrating[] getRatings() {
        return ratings;
    }
     ...
     * @param ratings
     */
    public void setRatings(com.quanganh9x.springwsclient.endpoint.place.Xmlrating[] ratings) {
        this.ratings = ratings;
    }

    public com.quanganh9x.springwsclient.endpoint.place.Xmlrating getRatings(int i) {
        return this.ratings[i];
    }

    public void setRatings(int i, com.quanganh9x.springwsclient.endpoint.place.Xmlrating _value) {
