...
public class Xmlrating  implements java.io.Serializable {
    ...
    private com.quanganh9x.springwsclient.endpoint.place.Xmluser user;
    ...
    public Xmlrating(
           int id,
           int point,
           com.quanganh9x.springwsclient.endpoint.place.Xmluser user,
     ...
     * @return user
     */
    public com.quanganh9x.springwsclient.endpoint.place.Xmluser getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(com.quanganh9x.springwsclient.endpoint.place.Xmluser user) {
        this.user = user;
    }
