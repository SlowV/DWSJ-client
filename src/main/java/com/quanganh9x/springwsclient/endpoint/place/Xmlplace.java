...
public class Xmlplace  implements java.io.Serializable {
    ...
    private com.quanganh9x.springwsclient.endpoint.place.Xmlimage[] images;
    ...
    public Xmlplace(
           ...
           com.quanganh9x.springwsclient.endpoint.place.Xmlimage[] images,
     ...
     * @return images
     */
    public com.quanganh9x.springwsclient.endpoint.place.Xmlimage[] getImages() {
        return images;
    }
     ...
     * @param images
     */
    public void setImages(com.quanganh9x.springwsclient.endpoint.place.Xmlimage[] images) {
        this.images = images;
    }

    public com.quanganh9x.springwsclient.endpoint.place.Xmlimage getImages(int i) {
        return this.images[i];
    }

    public void setImages(int i, com.quanganh9x.springwsclient.endpoint.place.Xmlimage _value) {
