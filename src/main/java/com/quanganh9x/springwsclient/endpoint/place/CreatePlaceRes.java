...
public class CreatePlaceRes  implements java.io.Serializable {
    private com.quanganh9x.springwsclient.endpoint.place.Xmlplace place;

    public CreatePlaceRes() {
    }
    ...
    /**
     * Gets the place value for this CreatePlaceRes.
     * 
     * @return place
     */
    ...
    /**
     * Sets the place value for this CreatePlaceRes.
     * 
     * @param place
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreatePlaceRes)) return false;
        CreatePlaceRes other = (CreatePlaceRes) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreatePlaceRes.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://quanganh9x.com/soap", ">createPlaceRes"));
