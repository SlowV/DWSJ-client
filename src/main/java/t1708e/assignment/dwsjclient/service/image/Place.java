...
public class Place  implements java.io.Serializable {
    private t1708e.assignment.dwsjclient.service.image.Comment[] comments;
    ...
    private t1708e.assignment.dwsjclient.service.image.Image[] images;

    private java.lang.String name;

    private t1708e.assignment.dwsjclient.service.image.Rating[] ratings;
    ...
    public Place(
           t1708e.assignment.dwsjclient.service.image.Comment[] comments,
           long createdAt,
           long deletedAt,
           java.lang.String description,
           long id,
           t1708e.assignment.dwsjclient.service.image.Image[] images,
           java.lang.String name,
           t1708e.assignment.dwsjclient.service.image.Rating[] ratings,
           int status,
           long updatedAt) {
     ...
     * @return comments
     */
    public t1708e.assignment.dwsjclient.service.image.Comment[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(t1708e.assignment.dwsjclient.service.image.Comment[] comments) {
        this.comments = comments;
    }

    public t1708e.assignment.dwsjclient.service.image.Comment getComments(int i) {
        return this.comments[i];
    }

    public void setComments(int i, t1708e.assignment.dwsjclient.service.image.Comment _value) {
     ...
     * @return images
     */
    public t1708e.assignment.dwsjclient.service.image.Image[] getImages() {
        return images;
    }
     ...
     * @param images
     */
    public void setImages(t1708e.assignment.dwsjclient.service.image.Image[] images) {
        this.images = images;
    }

    public t1708e.assignment.dwsjclient.service.image.Image getImages(int i) {
        return this.images[i];
    }

    public void setImages(int i, t1708e.assignment.dwsjclient.service.image.Image _value) {
     ...
     * @return ratings
     */
    public t1708e.assignment.dwsjclient.service.image.Rating[] getRatings() {
        return ratings;
    }
     ...
     * @param ratings
     */
    public void setRatings(t1708e.assignment.dwsjclient.service.image.Rating[] ratings) {
        this.ratings = ratings;
    }

    public t1708e.assignment.dwsjclient.service.image.Rating getRatings(int i) {
        return this.ratings[i];
    }

    public void setRatings(int i, t1708e.assignment.dwsjclient.service.image.Rating _value) {
