...
public class ImageServiceServiceLocator extends org.apache.axis.client.Service implements t1708e.assignment.dwsjclient.service.image.ImageServiceService {
    ...
    public t1708e.assignment.dwsjclient.service.image.ImageService getImageServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public t1708e.assignment.dwsjclient.service.image.ImageService getImageServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            t1708e.assignment.dwsjclient.service.image.ImageServicePortBindingStub _stub = new t1708e.assignment.dwsjclient.service.image.ImageServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (t1708e.assignment.dwsjclient.service.image.ImageService.class.isAssignableFrom(serviceEndpointInterface)) {
                t1708e.assignment.dwsjclient.service.image.ImageServicePortBindingStub _stub = new t1708e.assignment.dwsjclient.service.image.ImageServicePortBindingStub(new java.net.URL(ImageServicePort_address), this);
                _stub.setPortName(getImageServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.dwsj.assignment.t1708e/", "ImageServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.dwsj.assignment.t1708e/", "ImageServicePort"));
        }
