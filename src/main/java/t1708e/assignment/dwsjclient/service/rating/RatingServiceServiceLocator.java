...
public class RatingServiceServiceLocator extends org.apache.axis.client.Service implements t1708e.assignment.dwsjclient.service.rating.RatingServiceService {
    ...
    private java.lang.String RatingServicePort_address = "http://localhost:9000/rating";
    ...
    public t1708e.assignment.dwsjclient.service.rating.RatingService getRatingServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public t1708e.assignment.dwsjclient.service.rating.RatingService getRatingServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            t1708e.assignment.dwsjclient.service.rating.RatingServicePortBindingStub _stub = new t1708e.assignment.dwsjclient.service.rating.RatingServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (t1708e.assignment.dwsjclient.service.rating.RatingService.class.isAssignableFrom(serviceEndpointInterface)) {
                t1708e.assignment.dwsjclient.service.rating.RatingServicePortBindingStub _stub = new t1708e.assignment.dwsjclient.service.rating.RatingServicePortBindingStub(new java.net.URL(RatingServicePort_address), this);
                _stub.setPortName(getRatingServicePortWSDDServiceName());
                return _stub;
            }
        }
