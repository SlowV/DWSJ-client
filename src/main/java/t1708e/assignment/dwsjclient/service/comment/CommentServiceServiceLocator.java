...
public class CommentServiceServiceLocator extends org.apache.axis.client.Service implements t1708e.assignment.dwsjclient.service.comment.CommentServiceService {
    ...
    public t1708e.assignment.dwsjclient.service.comment.CommentService getCommentServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public t1708e.assignment.dwsjclient.service.comment.CommentService getCommentServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            t1708e.assignment.dwsjclient.service.comment.CommentServicePortBindingStub _stub = new t1708e.assignment.dwsjclient.service.comment.CommentServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (t1708e.assignment.dwsjclient.service.comment.CommentService.class.isAssignableFrom(serviceEndpointInterface)) {
                t1708e.assignment.dwsjclient.service.comment.CommentServicePortBindingStub _stub = new t1708e.assignment.dwsjclient.service.comment.CommentServicePortBindingStub(new java.net.URL(CommentServicePort_address), this);
                _stub.setPortName(getCommentServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.dwsj.assignment.t1708e/", "CommentServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.dwsj.assignment.t1708e/", "CommentServicePort"));
        }
