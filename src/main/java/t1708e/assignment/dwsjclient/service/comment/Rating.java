...
public class Rating  implements java.io.Serializable {
    ...
    private t1708e.assignment.dwsjclient.service.comment.Image image;

    private t1708e.assignment.dwsjclient.service.comment.Place place;
    ...
    private t1708e.assignment.dwsjclient.service.comment.User user;
    ...
    public Rating(
           ...
           long deletedAt,
           long id,
           t1708e.assignment.dwsjclient.service.comment.Image image,
           t1708e.assignment.dwsjclient.service.comment.Place place,
           double point,
           int status,
           long updatedAt,
           t1708e.assignment.dwsjclient.service.comment.User user) {
     ...
     * @return image
     */
    public t1708e.assignment.dwsjclient.service.comment.Image getImage() {
        return image;
    }
     ...
     * @param image
     */
    public void setImage(t1708e.assignment.dwsjclient.service.comment.Image image) {
        this.image = image;
    }
     ...
     * @return place
     */
    public t1708e.assignment.dwsjclient.service.comment.Place getPlace() {
        return place;
    }
     ...
     * @param place
     */
    public void setPlace(t1708e.assignment.dwsjclient.service.comment.Place place) {
        this.place = place;
    }
     ...
     * @return user
     */
    public t1708e.assignment.dwsjclient.service.comment.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(t1708e.assignment.dwsjclient.service.comment.User user) {
        this.user = user;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.travel.t1708e/", "rating"));
