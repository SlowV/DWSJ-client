...
public class Place  implements java.io.Serializable {
    ...
    private t1708e.assignment.dwsjclient.service.user.Image[] images;
    ...
    public Place(
           ...
           long id,
           t1708e.assignment.dwsjclient.service.user.Image[] images,
     ...
     * @return images
     */
    public t1708e.assignment.dwsjclient.service.user.Image[] getImages() {
        return images;
    }
     ...
     * @param images
     */
    public void setImages(t1708e.assignment.dwsjclient.service.user.Image[] images) {
        this.images = images;
    }

    public t1708e.assignment.dwsjclient.service.user.Image getImages(int i) {
        return this.images[i];
    }

    public void setImages(int i, t1708e.assignment.dwsjclient.service.user.Image _value) {
